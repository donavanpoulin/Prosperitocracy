...
#include "ProsperitocracyAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FProsperitocracyAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UProsperitocracyAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FProsperitocracyAbilityTagRelationship> AbilityTagRelationships;
